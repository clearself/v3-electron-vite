<template>
  <div class="app-container">
    <el-card v-loading="loading" shadow="never">
      ...
      <div class="table-wrapper">
        ...
        >
          ...
          <el-table-column prop="codeNum" label="产品编号" align="center" />
    ...
    <UploadImportTemu title="数据导入" v-model:show="showUpload" @success="successBack" />
  </div>
</template>
...
import UploadImportTemu from "@/components/UploadImportTemu/index.vue"
...
const exportToExcelSelected = () => {
  ...
  const titleArr = ["产品型号", "产品编号", "颜色", "尺寸", "FNSKU"] //表头第一行从左到右
  const fields = ["type", "codeNum", "color", "size", "code"] //标题对应的字段名
